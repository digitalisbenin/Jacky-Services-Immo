                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                style="background-image: url({{ asset('assets/images/slider/slider-image.jpg') }}); background-repeat: no-repeat; background-size: cover; background-position: right">
                                <div class="card-body p-lg-6">
                                    <h1>Bienvenu sur JACKY SERVICES IMMOBILIERS !</h1>
                                    <p>Que vous soyez au Bénin ou à l'étranger, Jacky Services - Immobilier est là pour vous accompagner dans la recherche du bien idéal. </p>
