                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class=""><a href="{{ url('articles') }}"
                                                                           class="text-inherit">Arcticle</a></li>/
                                            <li class="-item active" aria-current="page">Ajouter un article
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                <div class="card mb-6 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- input -->
                                            <div class="mb-3 col-lg-6">
                                                <label class="form-label">Site de l'article</label>
                                                <select class="form-select"
                                                        name="site_id" {{--id="categorie_id"--}} required>
                                                    <option selected>Site de l'article</option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="vedette"
                                                           id="inlineRadio1" value="villa"/>
                                                    <label class="form-check-label" for="inlineRadio1">Villa</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="vedette"
                                                           id="inlineRadio3" value="domaine"/>
                                                    <label class="form-check-label" for="inlineRadio1">Domaine</label>
                                                </div>
                                                <!-- input -->
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="vedette"
                                                           id="inlineRadio2" value="parcelle" checked/>
                                                    <label class="form-check-label" for="inlineRadio2">Parcelle
                                                        </label>
                                                </div>
                                                <!-- input -->
                                            </div>
