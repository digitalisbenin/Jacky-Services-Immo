                                        ...
                                        <table class="table table-centered table-hover text-nowrap table-borderless mb-0 table-with-checkbox">
                                            ...
                                            @foreach($article as $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{--  @if($value->vedette == 1)
                                                            <span class="badge bg-light-primary text-dark-primary">Parcelle</span>
                                                        @else
                                                            <span class="badge bg-light-warning text-dark-danger">Habitation</span>
                                                        @endif  --}}
                                                               @if ($value->vedette === 'parcelle')
                                                                    <span class="badge bg-light-primary text-dark-primary">Parcelle</span>
                                                                @elseif ($value->vedette === 'villa')
                                                                    <span class="badge bg-light-secondary text-white">Villa</span>
                                                                @elseif ($value->vedette === 'domaine')
                                                                    <span class="badge bg-light-warning text-dark-warning">Domaine</span>
                                                                @else
