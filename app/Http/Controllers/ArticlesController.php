...
class ArticlesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $article->vedette = $request->vedette;
        $article->disponible = $request->disponible == TRUE ? '1' : '0';
        $article->normal_price = $request->filled('normal_price') ? $request->normal_price : 0;
        $article->promo_price = $request->filled('promo_price') ? $request->promo_price : 0;
